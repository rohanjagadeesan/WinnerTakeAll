...
void makeBkg_for_highMult_jets(){
    ...
    //const int   trackbinboundsUpper[10]    = {20,30,40,50,59,66,76,83,1000,1000};     OLD

    const int   trackbin = 9;
    const int   trackbinbounds[trackbin]         = {0,25,36,48,60,71,78,91,97};
    const int   trackbinboundsUpper[trackbin]    = {25,36,48,60,71,78,91,97,1000}; // from xiao
    ...
    TFile* f= new TFile("/Users/rohanjagadeesan/Desktop/Code/li_lab/WinnerTakeAll/output/from_NOTS/per_batch/merged_signals.root","READ");
    ...
    TFile* fout= new TFile("/Users/rohanjagadeesan/Desktop/Code/li_lab/WinnerTakeAll/output/from_NOTS/per_batch/merged_bkg.root","RECREATE");
